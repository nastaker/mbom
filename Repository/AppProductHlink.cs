...
{
    [Table("TN_80_APP_0010_PRODUCT_HLINK")]
    public class AppProductHlink
    {
        [Key]
        ...
        public string CN_CUSTOMERCODE { get; set; }
        public string CN_CUSTOMERNAME { get; set; }
        public string CN_CUSTOMERITEMCODE { get; set; }
        public string CN_CUSTOMERITEMNAME { get; set; }
    }
}
